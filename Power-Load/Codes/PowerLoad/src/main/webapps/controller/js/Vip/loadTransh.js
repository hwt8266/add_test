$(document).ready(function() {
  	$("#pie-chart1").height(300);
  	$("#pie-chart2").height(300);
  	Piechart1 = echarts.init($("#pie-chart1")[0]);
  	Piechart2 = echarts.init($("#pie-chart2")[0]);
  	option1 = {
		       	tooltip: {
		            trigger: 'axis',
		            axisPointer: {
        		...
        		legend: {
            		top: 0,
            		left: 'left',
            		data: ['今天', '上个月今天', '去年今天', '今天影响因素', '上个月今天影响因素','去年今天影响因素']
        		},
		        yAxis: [
		            {
		            	name:'负荷(Kw)',
   ...
   $(function () { 
  		$('#collapseThree').on('show.bs.collapse', function () {
  			$("#arrow3").attr("src","../img/upicon.jpg");
  		});
    	$('#collapseThree').on('shown.bs.collapse', function () {
      		
      	});
      	$('#collapseThree').on('hide.bs.collapse', function () {
      		$("#arrow3").attr("src","../img/downicon.jpg");
      	});
   });
   $(function () { 
  		$('#collapseFour').on('show.bs.collapse', function () {
  			$("#arrow4").attr("src","../img/upicon.jpg");
  		});
    	$('#collapseFour').on('shown.bs.collapse', function () {
      		
      	});
      	$('#collapseFour').on('hide.bs.collapse', function () {
      		$("#arrow4").attr("src","../img/downicon.jpg");
      	});
   });
});
