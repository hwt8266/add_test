...
!function ($, moment) {
    ...
    var DateRangePicker = function (element, options, cb,id) {
    	this.id=id;
    ...
    $.fn.daterangepicker = function (options, cb,id) {
        this.each(function () {
            var el = $(this);
            if (el.data('daterangepicker'))
                el.data('daterangepicker').remove();
            el.data('daterangepicker', new DateRangePicker(el, options, cb,id));
        });
        return this;
    };
